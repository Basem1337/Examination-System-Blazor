...
namespace ExaminationSystem.Migrations
{
    ...
    [Migration("20250608205935_FixCourseExamRelationship")]
    partial class FixCourseExamRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExaminationSystem.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "Inst-01",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "587e7e02-610d-4418-8a17-94a2a5ed34a9",
                            Email = "basem.m1337@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "BASEM.M1337@GMAIL.COM",
                            NormalizedUserName = "BASEM.M1337@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEHqGq253K908mtBRJy0lfSRLAPkHreuWVx8AJd1B2t4ICzMBHmAY7LxTlpTaUPJE9w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0554e6f8-e141-4afd-8edc-d631a8eec25d",
            ...
            modelBuilder.Entity("ExaminationSystem.Models.Exam", b =>
                {
                    b.HasOne("ExaminationSystem.Models.Course", "Course")
                        .WithOne("Exam")
                        .HasForeignKey("ExaminationSystem.Models.Exam", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
